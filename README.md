...
- <i class="far fa-exclamation"></i> [Understanding the web]
...
[web-with-python-tips]
- [Tips & Tricks](https://buildmedia.readthedocs.org/media/pdf/intermediatepythongithubio/latest/intermediatepythongithubio.pdf)
